...
public class SwipeMenuLayout extends FrameLayout implements SwipeSwitch {
    ...
    private static final int MAX_OVER_SCROLL_LEFT_X = 100;
    private static final int MAX_OVER_SCROLL_RIGHT_X = 50;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                mContentView.setBackgroundColor(ContextCompat.getColor(mContext, R.color.transparent));
                mLastX = (int) ev.getX();
                mLastY = (int) ev.getY();
                break;
            case MotionEvent.ACTION_MOVE:
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset() && mSwipeCurrentHorizontal != null) {
            ...
            if (mSwipeCurrentHorizontal instanceof SwipeRightHorizontal) {
//                if (oldX != currX) {
//                    overScrollBy(currX - oldX, 0, oldX, 0, 0, 0, MAX_OVER_SCROLL_LEFT_X, 0, false);
//                }
//                postInvalidate();
...
//                if (oldX != currX) {
//                    overScrollBy(currX - oldX, 0, oldX, 0, 0, 0, MAX_OVER_SCROLL_RIGHT_X, 0, false);
//                }
//                postInvalidate();
//                if (oldX != currX) {
//                    overScrollBy(currX - oldX, 0, oldX, 0, 0, 0, MAX_OVER_SCROLL_X, 0, false);
//                }
//                this.postInvalidate();
                scrollTo(-Math.abs(mScroller.getCurrX()), 0);
                invalidate();
...
//            if (clampedX) {
//                if (mSwipeCurrentHorizontal instanceof SwipeRightHorizontal) {
//                    mScroller.springBack(-200, 0, 0, 0, 0, 0);
//                } else {
//                    mScroller.springBack(200, 0, 0, 0, 0, 0);
//                }
//            }
