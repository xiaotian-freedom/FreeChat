...
public class SwipeMenuItem {
    ...
    public SwipeMenuItem setLeft(int left) {
        this.left = left;
        return this;
    }
    ...
    public SwipeMenuItem setRight(int right) {
        this.right = right;
        return this;
    }
    ...
    public SwipeMenuItem setTop(int top) {
        this.top = top;
        return this;
    }

    public SwipeMenuItem setBottom(int bottom) {
        this.bottom = bottom;
        return this;
    }
}
