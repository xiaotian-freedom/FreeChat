...
/**
 *
 * 带有展开关闭动画的expandableListView
 * Created by tianshutong on 16/8/22.
 */

public class AnimatedExpandableListView extends FixedExpandableListView {
    ...
    public AnimatedExpandableListView(Context context, AttributeSet attrs, int defStyleAttr) {
