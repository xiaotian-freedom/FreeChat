...
public class CompactCalendarView extends View {
    ...
    public CompactCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        compactCalendarController = new CompactCalendarController(new Paint(), new OverScroller(getContext()),
                ...
                Color.argb(255, 64, 64, 64), Color.argb(255, 64, 64, 64), Color.argb(255, 219, 219, 219), VelocityTracker.obtain(),
    ...
    public void setUnClickableTextColor(int unClickableTextColor) {
        compactCalendarController.setUnClickableTextColor(unClickableTextColor);
        invalidate();
    }

    public void setClickableList(List<String> mList) {
        compactCalendarController.setClickableList(mList);
        invalidate();
    }

    public void setTodayDayOfMonth(int dayOfMonth) {
        compactCalendarController.setTodayDayOfMonth(dayOfMonth);
        invalidate();
    }
